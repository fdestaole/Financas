...
export function CalculatorPopup({ initialValue, onConfirm, onClose }: Props) {
  const initDisplay = initialValue !== 0 ? String(initialValue).replace(".", ",") : "0";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-4 gap-1">
        ...
        <button className={op(false)} onClick={handlePercent}>
          %
        </button>
        <button className={op(isActiveOp("/"))} onClick={() => handleOperator("/")}>
          ÷
        </button>

        {/* Row 2 */}
        <button className={num} onClick={() => handleDigit("7")}>
          7
        </button>
        <button className={num} onClick={() => handleDigit("8")}>
          8
        </button>
        <button className={num} onClick={() => handleDigit("9")}>
          9
        </button>
        <button className={op(isActiveOp("*"))} onClick={() => handleOperator("*")}>
          ×
        ...
        {/* Row 3 */}
        <button className={num} onClick={() => handleDigit("4")}>
          4
        </button>
        <button className={num} onClick={() => handleDigit("5")}>
          5
        </button>
        <button className={num} onClick={() => handleDigit("6")}>
          6
        </button>
        <button className={op(isActiveOp("-"))} onClick={() => handleOperator("-")}>
          −
        ...
        {/* Row 4 */}
        <button className={num} onClick={() => handleDigit("1")}>
          1
        </button>
        <button className={num} onClick={() => handleDigit("2")}>
          2
        </button>
        <button className={num} onClick={() => handleDigit("3")}>
          3
        </button>
        <button className={op(isActiveOp("+"))} onClick={() => handleOperator("+")}>
          +
        ...
        <button className={num} onClick={() => handleDigit(",")}>
          ,
        </button>
        <button
